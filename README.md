...
## Usage
```
usage: timedil.py [-h] [-s SPEED | -m METERSPERSEC] [-l LIGHTYEARS]
                  [-sl SHIPLENGTH] [-p PRECISION]
...
optional arguments:
  ...
  -s SPEED, --speed SPEED
                        ...
                        Speed of light = 1
  -m METERSPERSEC, --meterspersec METERSPERSEC
...
```
~/wunderhund/timedil(master*) » ./timedil.py -s 0.5 -l 4.3                                      2019-09-30 23:27:11
...
```
~/wunderhund/timedil(master*) » ./timedil.py -m 17000 -l 4.3                                    2019-09-30 23:26:46
Lightyears to travel:  4.3
...
```
~/wunderhund/timedil(master*) » ./timedil.py -s 1516 -l 4.3                                     2019-09-30 23:25:50
Lightyears to travel:  4.3
...
```
~/wunderhund/timedil(master) » ./timedil.py -s 1.414213562373095 -l 4.3                         2019-09-30 23:21:04
Lightyears to travel:  4.3
